...
export default function Dashboard({ auth , myPendingTasks , myCompletedTasks ,myInprogressTasks , totalTasks , myactiveTasks}) {
    return (
        <AuthenticatedLayout
            user={auth.user}
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-3 gap-2">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h3 className="text-green-600 text-2xl font-semibold">Completed Tasks</h3>
                            <p className="text-xlg mt-4">

                            ...
                            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                                <tr className="text-nowrap">
                                   ...
                                   <TableHeading 
                                    ...
                                    <th>
                                    <div className="px-3 py-3 flex items-center justify-between gap-1">Created By</div></th>
                                    <th text-right:true="true">
                                    <div className="px-3 py-3 flex items-center justify-between gap-1">Actions</div></th>
                                </tr>
                            </thead>
                            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                                <tr className="text-nowrap">
                                    ...
                                    <th className="px-3 py-3">
                                        ...
                                        defaultValue={queryParams.status}  onChange={e => searchFieldChanged('status',e.target.value)}>

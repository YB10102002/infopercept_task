...
const ProductDetail = () => {
    ...
    const fetchProductDetails = async () => {
        setLoading(true);
        const res = await fetch(AllApi.productDetails.url, {
            method: AllApi.productDetails.method,
            headers: {
        ...
        <div className='container mx-auto p-4'>
                        ...
                        (
                            <div className='flex flex-col gap-1'>
                                ...
                                <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1'>
                                    <p className='text-red-600'>{dispalyINR(data.sellingPrice)}</p>
                                    <p className='text-slate-400 line-through'>{dispalyINR(data.price)}</p>
                                </div>
...

            {
                data.productCategory && (
                    <VerticalProductCard category={data.productCategory} heading="You also like this" />
                )
            }
